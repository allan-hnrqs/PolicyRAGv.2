...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the authored multi-turn benchmark against a profile.")
    parser.add_argument(
        "--profile",
        default="demo",
    ...
    parser.add_argument(
        "--manifest",
        default="datasets/eval/manifests/multiturn_benchmark_v1.json",
        help="Path to the multi-turn benchmark manifest.",
    )
